...
('root', '[{\"db\":\"user_accounts\",\"table\":\"user_accounts\"},{\"db\":\"mysql\",\"table\":\"columns_priv\"}]');
...
('root', '2022-07-05 02:03:20', '{\"Console\\/Mode\":\"collapse\"}');
...
--
CREATE DATABASE IF NOT EXISTS `pocketguide` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `pocketguide`;
--
-- Database: `test`
--
